...
export const en = {
  ...
  auth: {
    ...
    sentMessage: 'We sent a reset link to {email}. Open it to choose a new password.',
    ...
    resetSubtitle: 'Choose a new password for your Varlikent account.',
    resetAction: 'Reset Password',
    resetSaving: 'Saving…',
    resetDoneTitle: 'Password updated',
    resetDoneBody: 'You can now sign in with your new password.',
    resetInvalidTitle: 'This link is not valid',
    resetInvalidBody: 'The reset link is missing or incomplete. Please request a new one.',
  ...
  favourites: {
    title: 'My Favourites',
    gateEyebrow: 'Saved',
    gateTitle: 'Save your favourite properties',
    gateDescription: 'Sign in to keep the properties you love in one place.',
    emptyTitle: 'No favourites yet',
    emptyDescription: 'Save properties you like and find them here anytime.',
    browseProperties: 'Browse Properties',
    loadError: 'Could not load your favourites',
    add: 'Add to favourites',
    remove: 'Remove from favourites',
    actionFailed: 'Could not update favourites',
  },
