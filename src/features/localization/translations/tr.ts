...
export const tr: TranslationShape = {
  ...
  auth: {
    ...
    sentMessage: '{email} adresine bir sıfırlama bağlantısı gönderdik. Yeni bir şifre seçmek için bağlantıyı açın.',
    spamNote: 'Bulamıyor musunuz? Spam veya gereksiz klasörünüzü kontrol edin.',
    resendLink: 'Bağlantıyı tekrar gönder',
    resendCooldown: 'Tekrar gönder ({seconds} sn)',
    resendFailed: 'Bağlantı tekrar gönderilemedi. Lütfen yeniden deneyin.',
    backToSignIn: 'Girişe Dön',
    rememberedIt: 'Hatırladınız mı?',
    newPassword: 'Yeni Şifre',
    passwordTooShort: 'Şifre en az 6 karakter olmalıdır.',
    resetTitle: 'Yeni Şifre Belirleyin',
    resetSubtitle: 'Varlikent hesabınız için yeni bir şifre seçin.',
    resetAction: 'Şifreyi Sıfırla',
    resetSaving: 'Kaydediliyor…',
    resetDoneTitle: 'Şifre güncellendi',
    resetDoneBody: 'Artık yeni şifrenizle giriş yapabilirsiniz.',
    resetInvalidTitle: 'Bu bağlantı geçerli değil',
    resetInvalidBody: 'Sıfırlama bağlantısı eksik veya hatalı. Lütfen yeni bir tane isteyin.',
  ...
  favourites: {
    title: 'Favorilerim',
    gateEyebrow: 'Kaydedilenler',
    gateTitle: 'Favori mülklerinizi kaydedin',
    gateDescription: 'Beğendiğiniz mülkleri tek bir yerde tutmak için giriş yapın.',
    emptyTitle: 'Henüz favori yok',
    emptyDescription: 'Beğendiğiniz mülkleri kaydedin, istediğiniz zaman burada bulun.',
    browseProperties: 'Mülklere Göz At',
    loadError: 'Favorileriniz yüklenemedi',
    add: 'Favorilere ekle',
    remove: 'Favorilerden çıkar',
    actionFailed: 'Favoriler güncellenemedi',
  },
